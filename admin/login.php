...
<head>
    ...
    <!-- Title -->
    <title>Log In Admin| NRWS KOSMETIK</title>
...
<body>
        ...
        <div class="container py-5 py-sm-7">
            ...
            <div class="mx-auto" style="max-width: 30rem;">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form role="form" method="post" class="js-validate needs-validation" >
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-5">Admin Log In</h1>
                                </div>
                                <!-- Form -->
                                <div class="mb-4">
                                    <label class="form-label" for="signinSrEmail">Masukkan Username</label>
                                    <input type="text" class="form-control form-control-lg" name="user" id="signinSrEmail" tabindex="1" placeholder="email@address.com" aria-label="email@address.com" required>
                                    <span class="invalid-feedback">Tolong Masukkan Username Yang Benar.</span>
                                </div>
                                <!-- End Form -->
    ...
    HSBsValidation.init('.js-validate', {
        onSubmit: data => {
            // Cek jika form valid sebelum mengirimkan
            if (data.isValid) {
                data.event.preventDefault(); // Cegah pengiriman default
                // Kirim form secara manual menggunakan AJAX atau metode lain
                // Contoh: 
                // var formData = new FormData(data.form);
                // fetch(data.form.action, { method: 'POST', body: formData })
                //     .then(response => response.text())
                //     .then(result => { /* tangani hasilnya */ })
