...
<div class="content container-fluid">
        ...
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title">Kelola Data Pelanggan</h1>
            </div>
        </div>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a class="btn btn-danger btn-sm" href="hapuspelanggan.php?id=<?php echo $pecah['id_pelanggan']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
