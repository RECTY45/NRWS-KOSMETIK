...
include 'DashboardCount/CountPelanggan.php';
include 'DashboardCount/CountPembelian.php';
include 'DashboardCount/CountProduk.php';
...
<head>
  ...
  <!-- Title -->
  <title>Dashboard | NRWS KOSMETIK</title>
